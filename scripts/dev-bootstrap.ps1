...
# Compose (--env-file) and Terraform cannot parse. Write UTF-8 without a BOM so
# the generated files are portable across non-PowerShell tooling.
...
Write-Utf8NoBom -Path (Join-Path $EnvDir 'dev.tfvars') -Content $DevTfvars
